// ======================================================================
// microOLED_example.v generated from TopDesign.cysch
// 05/18/2019 at 22:49
...
module SCB_P4_v4_0_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("f1946b33-e3e4-495d-929d-fa695e72ab1d/dca0e846-8bc7-4093-9ffa-1f50f68478c5/5382e105-1382-4a2e-b9f4-3bb2feba71e0"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f1946b33-e3e4-495d-929d-fa695e72ab1d/dca0e846-8bc7-4093-9ffa-1f50f68478c5/22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
// OLED_SSD1306(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OLED_SSD1306, CY_CONFIG_TITLE=OLED_SSD1306_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=OLED_SSD1306_1, CY_INSTANCE_SHORT_NAME=OLED_SSD1306_1, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=OLED_SSD1306_1, )
module OLED_SSD1306_1 (
    T_OLED_Reset,
    T_OLED_ADDR_Select);
    inout       T_OLED_Reset;
    electrical  T_OLED_Reset;
    inout       T_OLED_ADDR_Select;
    electrical  T_OLED_ADDR_Select;
	...
	wire [0:0] tmpOE__OLED_ADDR_Select_net;
	wire [0:0] tmpFB_0__OLED_ADDR_Select_net;
	wire [0:0] tmpIO_0__OLED_ADDR_Select_net;
	wire [0:0] tmpINTERRUPT_0__OLED_ADDR_Select_net;
	electrical [0:0] tmpSIOVREF__OLED_ADDR_Select_net;

	cy_psoc3_pins_v1_10
		#(.id("f1946b33-e3e4-495d-929d-fa695e72ab1d/e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_ADDR_Select
		 (.oe(tmpOE__OLED_ADDR_Select_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OLED_ADDR_Select_net[0:0]}),
		  .io({tmpIO_0__OLED_ADDR_Select_net[0:0]}),
		  .siovref(tmpSIOVREF__OLED_ADDR_Select_net),
		  .interrupt({tmpINTERRUPT_0__OLED_ADDR_Select_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_ADDR_Select_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("f1946b33-e3e4-495d-929d-fa695e72ab1d/ceead579-3635-44eb-b90f-5f62fa419402"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    OLED_SSD1306_1 OLED_SSD1306_1 (
        .T_OLED_Reset(Net_37),
        .T_OLED_ADDR_Select(Net_38));
